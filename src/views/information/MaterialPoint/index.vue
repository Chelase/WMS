      ...
      >
        ...
        <el-table-column property="Type" label="类型" width="80">
          <template #default="scope">
            <p v-if="scope.row.Type === 'In'">只进</p>
            <p v-else-if="scope.row.Type === 'Out'">只出</p>
            <p v-else-if="scope.row.Type === 'InOut'">进出</p>
            <p v-else>出回</p>
          </template>
        </el-table-column>
        ...
        <el-table-column label="操作">
          <template #default="scope">
            <el-button type="primary" link @click="OpenMaterialPontShow('edit', scope.row.Id)">编辑</el-button>
